...
<body>
    ...
    <form action="../php_actions/action_register.php" method="POST">
        <input type="text" name="email" id="txt_1" onkeyup='saveValue(this);' placeholder="E-mail"><br>
        <input type="text" name="nick" id="txt_2" onkeyup='saveValue(this);' placeholder="Nickname"> <br>
